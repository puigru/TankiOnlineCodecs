# Codec definitions autogenerated on Fri, 29 May 2020 04:29:43 GMT
# Decompiler: JPEXS Free Flash Decompiler v.11.3.0
# game-d7c227a44cb376759e7049569ad64986.swf
# entrance-b112a603b602a68948018401f200d66a.swf
...
class AssaultCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['blueFlagPedestalModel'] = packet.readLong()
        data['flagSprite'] = packet.readLong()
        data['pointBigMarker'] = packet.readLong()
        data['pointResources'] = PointResources().read(packet, optional)
        data['pointSmallMarker'] = packet.readLong()
        data['redFlagPedestalModel'] = packet.readLong()
...
class AvailableUpgradeItem(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['available'] = bool(packet.readByte())
        data['category'] = packet.readInt()
        data['timeToEndUpgradeInSec'] = packet.readLong()
        return data

class AvailableUpgradesCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(AvailableUpgradeItem().read(packet, optional))
        data['availableUpgradeItems'] = items
        return data

class AvailableUpgradesModelBase_updateAvailableUpgrade(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(AvailableUpgradeItem().read(packet, optional))
        data['isAvailableItems'] = items
        return data
...
class BraintreePaymentCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['payPal'] = bool(packet.readByte())
        return data

class BraintreePaymentModelBase_receiveUrl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['url'] = PaymentRequestUrl().read(packet, optional)
        return data

class BraintreePaymentModelServer_getPaymentUrl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shopItemId'] = packet.readLong()
        return data
...
class CaptureTheFlagCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['blueFlagSprite'] = packet.readLong()
        data['bluePedestalModel'] = packet.readLong()
        data['redFlagSprite'] = packet.readLong()
        data['redPedestalModel'] = packet.readLong()
...
class ClanInfoModelServer_changeFlag(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['flagId'] = packet.readLong()
        return data
...
class ClanInfoModelServer_updateDescription(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['description'] = packet.readString()
        return data
...
class ClanPanelNotificationCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['numberNotifications'] = packet.readInt()
        data['restrictionTimeJoinClanInSec'] = packet.readInt()
        return data

class ClanPanelNotificationModelBase_added(Codec):
    pass

class ClanPanelNotificationModelBase_removed(Codec):
    pass
...
class PaymentPackage(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['amountCrystals'] = packet.readInt()
        data['bonusCrystals'] = packet.readInt()
        data['currency'] = packet.readString()
        data['premiumDurationInDays'] = packet.readInt()
        data['price'] = packet.readDouble()
        return data

class CrystalsPaymentCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['accountId'] = packet.readString()
        data['calculatorEnabled'] = bool(packet.readByte())
        data['crystalCost'] = packet.readDouble()
        data['defaultAmountOfCrystals'] = packet.readInt()
        data['greaterMaximumCrystalsMessage'] = None if optional.next() else packet.readString()
        data['greaterMaximumMoneyMessage'] = None if optional.next() else packet.readString()
        data['lessMinimumCrystalsMessage'] = None if optional.next() else packet.readString()
        data['lessMinimumMoneyMessage'] = None if optional.next() else packet.readString()
        data['manualDescription'] = packet.readString()
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(PaymentPackage().read(packet, optional))
        data['paymentPackages'] = items
        return data
...
class DamageIndicatorModelBase(Codec):
    pass
...
class EngineCC(Codec):
    def read(self, packet, optional):
        ...
        data['engineStartSound'] = packet.readLong()
        data['engineStopMovingSound'] = packet.readLong()
        return data
...
class Gate2ShopPaymentCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['emailInputRequired'] = bool(packet.readByte())
        return data

class Gate2ShopPaymentModelBase_receiveUrl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['url'] = PaymentRequestUrl().read(packet, optional)
        return data

class Gate2ShopPaymentModelBase_showEmailIsBusy(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['email'] = packet.readString()
        return data

class Gate2ShopPaymentModelBase_showEmailIsForbidden(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['email'] = packet.readString()
        return data

class Gate2ShopPaymentModelBase_showEmailIsFree(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['email'] = packet.readString()
        return data

class Gate2ShopPaymentModelServer_getPaymentUrl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shopItemId'] = packet.readLong()
        return data

class Gate2ShopPaymentModelServer_registerEmailAndGetPaymentUrl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shopItemId'] = packet.readLong()
        data['email'] = packet.readString()
...
class Gate2ShopPaymentModelServer_validateEmail(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['email'] = packet.readString()
        return data
...
class MatchMakingUserInfo(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['friend'] = bool(packet.readByte())
        data['id'] = packet.readLong()
        data['onLine'] = bool(packet.readByte())
        data['rank'] = packet.readInt()
        data['sameClan'] = bool(packet.readByte())
        data['uid'] = packet.readString()
        return data

class GroupInviteWindowModelBase_setAvailableToInviteUsers(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(MatchMakingUserInfo().read(packet, optional))
        data['friends'] = items
        return data
...
class GroupInviteWindowModelServer_getFriends(Codec):
    pass
...
class JuggernautCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['bossHudMarker'] = packet.readLong()
...
class LaserPointerCC(Codec):
    def read(self, packet, optional):
        ...
        data['laserPointerBlueColor'] = packet.readString()
...
class LicenseClanShopItemModelBase(Codec):
    pass
...
class MachineGunSFXCC(Codec):
    def read(self, packet, optional):
        ...
        data['crumbsTexture'] = packet.readLong()
        data['dustTexture'] = packet.readLong()
        ...
        data['ricochetTexture'] = packet.readLong()
        ...
        data['smokeTexture'] = packet.readLong()
        data['sparklesTexture'] = packet.readLong()
        ...
        data['tankSparklesTexture'] = packet.readLong()
        data['tracerTexture'] = packet.readLong()
        return data
...
class MobileLootBoxDeliveryCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['periodOfGiveLootBoxInMin'] = packet.readInt()
        data['remainingTimeToGiveLootBoxInSec'] = packet.readInt()
        return data

class MobileLootBoxModelBase(Codec):
    pass

class MobileLoot(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['count'] = packet.readInt()
        data['image'] = packet.readLong()
...
class MobileLootBoxModelBase_openSuccessful(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(MobileLoot().read(packet, optional))
        data['rewards'] = items
        return data

class MobileLootBoxModelBase_openingFailed(Codec):
    pass

class MobileLootBoxModelBase_updateCount(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['count'] = packet.readInt()
        return data

class MobileLootBoxModelServer_open(Codec):
    pass
...
class NewbiesAbonementShowInfoModelBase(Codec):
    pass

class NewbiesAbonementShowInfoModelBase_showInfoWindow(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['lifeTimeInSecondsFromCurrentDateTime'] = packet.readInt()
        data['crystalBonusInPersent'] = packet.readInt()
        data['scoreBonusInPercent'] = packet.readInt()
        return data
...
class PayPalKitViewModelBase(Codec):
    pass
...
class RocketLauncherSfxCC(Codec):
    def read(self, packet, optional):
        ...
        data['rocketTexture'] = packet.readLong()
        data['targetLostSound'] = packet.readLong()
        return data
...
class RugbyCC(Codec):
    def read(self, packet, optional):
        ...
        data['bigBlueBallMarker'] = packet.readLong()
        data['bigGreenBallMarker'] = packet.readLong()
        data['bigRedBallMarker'] = packet.readLong()
        data['blueBallMarker'] = packet.readLong()
        data['blueGoalModel'] = packet.readLong()
        data['cordResource'] = packet.readLong()
        data['greenBallMarker'] = packet.readLong()
        data['parachuteInnerResource'] = packet.readLong()
        data['parachuteResource'] = packet.readLong()
        data['redBallMarker'] = packet.readLong()
...
class Country(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['id'] = packet.readString()
        data['name'] = packet.readString()
        return data

class SMSPayModeCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(Country().read(packet, optional))
        data['countries'] = items
        return data

class SMSNumber(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['cost'] = packet.readDouble()
        data['crystals'] = packet.readInt()
        data['currency'] = packet.readString()
        data['number'] = packet.readString()
        data['smsText'] = packet.readString()
        return data

class SMSPayModeModelBase_setNumbers(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(SMSNumber().read(packet, optional))
        data['smsNumbers'] = items
        return data

class SMSOperator(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['id'] = packet.readInt()
        data['name'] = packet.readString()
...
class SMSPayModeModelBase_setOperators(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(SMSOperator().read(packet, optional))
        data['operators'] = items
        return data

class SMSPayModeModelServer_getNumbers(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['operatorId'] = packet.readInt()
        return data

class SMSPayModeModelServer_getOperators(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['countryId'] = packet.readString()
        return data
...
class SmokyModelBase(Codec):
    pass

class SmokyModelBase_localCriticalHit(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['target'] = packet.readLong()
        return data

class SmokyModelBase_shoot(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shooter'] = packet.readLong()
        return data

class SmokyModelBase_shootStatic(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shooter'] = packet.readLong()
...
class SmokyModelBase_shootTarget(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shooter'] = packet.readLong()
        data['target'] = packet.readLong()
...
class SmokyModelServer_fireStaticCommand(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['clientTime'] = packet.readInt()
        data['hitPoint'] = Vector3d().read(packet, optional)
...
class SmokyModelServer_fireTargetCommand(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['clientTime'] = packet.readInt()
        data['target'] = packet.readLong()
...
class SpeedCharacteristicsCC(Codec):
    def read(self, packet, optional):
        ...
        data['reverseTurnAcceleration'] = packet.readFloat()
        data['sideAcceleration'] = packet.readFloat()
        data['turnAcceleration'] = packet.readFloat()
        data['turnStabilizationAcceleration'] = packet.readFloat()
        return data
...
class UserReward(Codec):
    def read(self, packet, optional):
        ...
        data['newbiesAbonementBonusReward'] = packet.readInt()
...
class StatisticsTeamCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['blueScore'] = packet.readInt()
        data['redScore'] = packet.readInt()
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(UserInfo().read(packet, optional))
        data['usersInfoBlue'] = items
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(UserInfo().read(packet, optional))
        data['usersInfoRed'] = items
        return data
...
class TankState(Codec):
    def read(self, packet, optional):
        ...
        data['chassisControl'] = packet.readByte()
        data['chassisTurnSpeedNumber'] = packet.readByte()
...
class TankModelBase_move(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['moveCommand'] = MoveCommand().read(packet, optional)
        return data

class TankModelBase_movementControl(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['control'] = packet.readByte()
        data['turnSpeedNumber'] = packet.readByte()
...
class TankModelServer_moveCommand(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['clientTime'] = packet.readInt()
        data['specificationId'] = packet.readShort()
...
class TankModelServer_movementControlCommand(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['clientTime'] = packet.readInt()
        data['specificationId'] = packet.readShort()
...
class TankTurnOverModelBase(Codec):
    pass
...
class TeamBattleInfoCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['scoreBlue'] = packet.readInt()
        data['scoreRed'] = packet.readInt()
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(BattleInfoUser().read(packet, optional))
        data['usersBlue'] = items
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(BattleInfoUser().read(packet, optional))
        data['usersRed'] = items
...
class TeamJuggernautCC(Codec):
    def read(self, packet, optional):
        ...
        data['bossKilledSound'] = packet.readLong()
        data['bossSpawnedSound'] = packet.readLong()
        data['currentBlueBoss'] = None if optional.next() else packet.readLong()
        data['currentRedBoss'] = None if optional.next() else packet.readLong()
...
class TerminalPaymentCC(Codec):
    def read(self, packet, optional):
        ...
        data['text'] = packet.readString()
        data['withCalculator'] = bool(packet.readByte())
        return data
...
class TitanUltimateGeneratorCC(Codec):
    def read(self, packet, optional):
        ...
        data['blueSphere'] = packet.readLong()
...
class TutorialHintsData(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['canBuyTargetItem'] = bool(packet.readByte())
        data['canUpgrageCurrentTurret'] = bool(packet.readByte())
        data['hasUntakenQuestPrize'] = bool(packet.readByte())
        data['mountedTurretId'] = packet.readLong()
        data['neverBoughtTurretOrWeapon'] = bool(packet.readByte())
        data['neverUpgradeTurretOrWeapon'] = bool(packet.readByte())
        data['targetToBuyItemId'] = packet.readLong()
        return data

class TutorialHintsCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['tutorialHintsData'] = TutorialHintsData().read(packet, optional)
        return data

class TutorialHintsModelBase_update(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['tutorialHintsData'] = TutorialHintsData().read(packet, optional)
        return data
...
class UserCountryCC(Codec):
    def read(self, packet, optional):
        ...
        items = list()
        for _ in range(protocol.decode_length(packet)):
            items.append(CountryInfo().read(packet, optional))
        data['countries'] = items
        data['defaultCountryCode'] = None if optional.next() else packet.readString()
        data['locationCheckEnabled'] = bool(packet.readByte())
        return data

class UserCountryModelBase_requestUserCountry(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['defaultCountryCode'] = None if optional.next() else packet.readString()
        return data

class UserCountryModelBase_showPaymentWindow(Codec):
    pass

class UserCountryModelServer_checkUserPaymentCountry(Codec):
    pass

class UserCountryModelServer_setCurrentPaymentCountry(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['countryCode'] = packet.readString()
        return data
...
class VideoAdsMobileLootBoxCC(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['adsAvailable'] = bool(packet.readByte())
        return data

class VideoAdsMobileLootBoxModelServer_showed(Codec):
    pass
...
CODECS = {
    ...
    7315088189361785539: AvailableUpgradesCC(),
    257922709133275790: AvailableUpgradesModelBase_updateAvailableUpgrade(),
    ...
    758432772834372746: BraintreePaymentCC(),
    8864450706997215977: BraintreePaymentModelBase_receiveUrl(),
    1152553047746868620: BraintreePaymentModelServer_getPaymentUrl(),
    ...
    34297217873591053: ClanInfoModelServer_changeFlag(),
    ...
    866377010168518180: ClanInfoModelServer_updateDescription(),
    ...
    6817586863323090661: ClanPanelNotificationModelBase_added(),
    3106829501724123397: ClanPanelNotificationModelBase_removed(),
    ...
    7644139797456901687: CommonFacilityCC(),
    5528254722389644251: CommonFacilityModelBase_markAsDispelled(),
    ...
    7886670065247534615: CrystalsPaymentCC(),
    ...
    3248199557469599724: DamageIndicatorModelBase(),
    ...
    3935107155251354407: DescriptionModelCC(),
    ...
    4158018907694004106: ShotCC(),
    6671275320905029340: DiscreteShotModelBase_reconfigureWeapon(),
    ...
    4315075718429327704: Gate2ShopPaymentCC(),
    4373509491687899191: Gate2ShopPaymentModelBase_receiveUrl(),
    4279657133457041317: Gate2ShopPaymentModelBase_showEmailIsBusy(),
    8205786517858628045: Gate2ShopPaymentModelBase_showEmailIsForbidden(),
    4279657133457157144: Gate2ShopPaymentModelBase_showEmailIsFree(),
    3452468287774630502: Gate2ShopPaymentModelServer_getPaymentUrl(),
    7915056451801120732: Gate2ShopPaymentModelServer_registerEmailAndGetPaymentUrl(),
    8254945430271004737: Gate2ShopPaymentModelServer_validateEmail(),
    ...
    275059047126413636: GroupInviteWindowModelBase_setAvailableToInviteUsers(),
    5278663298164192098: GroupInviteWindowModelBase_show(),
    6624267853360047048: GroupInviteWindowModelServer_getFriends(),
    ...
    766893533640681716: MobileLootBoxDeliveryCC(),
    3410147941016164436: MobileLootBoxModelBase(),
    3490467046324997051: MobileLootBoxModelBase_openSuccessful(),
    3682914700094940204: MobileLootBoxModelBase_openingFailed(),
    6007064502922370651: MobileLootBoxModelBase_updateCount(),
    8639730549550121261: MobileLootBoxModelServer_open(),
    ...
    4803961593880771729: NewbiesAbonementShowInfoModelBase(),
    2250229722573461505: NewbiesAbonementShowInfoModelBase_showInfoWindow(),
    ...
    1532858009489136688: PayPalKitViewModelBase(),
    ...
    8324908588833997371: SMSPayModeCC(),
    3121781002040921960: SMSPayModeModelBase_setNumbers(),
    6787741762013279005: SMSPayModeModelBase_setOperators(),
    2680986931618394964: SMSPayModeModelServer_getNumbers(),
    6115729742742034993: SMSPayModeModelServer_getOperators(),
    ...
    2172139419072369403: SmokyModelBase(),
    5645206942441648925: SmokyModelBase_localCriticalHit(),
    5513207377268960901: SmokyModelBase_shoot(),
    4100592046364094803: SmokyModelBase_shootStatic(),
    4100592046375670902: SmokyModelBase_shootTarget(),
    682326792057158253: SmokyModelServer_fireCommand(),
    7586454165429681851: SmokyModelServer_fireStaticCommand(),
    7267965420731948862: SmokyModelServer_fireTargetCommand(),
    ...
    3503849245765586498: TankModelBase_move(),
    4537830264914226593: TankModelBase_movementControl(),
    ...
    9081012168130771749: TankModelServer_moveCommand(),
    4416440204413517838: TankModelServer_movementControlCommand(),
    ...
    4206032257972775630: TankTurnOverModelBase(),
    ...
    6545589271536683676: TutorialHintsCC(),
    8467361455597558662: TutorialHintsModelBase_update(),
    ...
    6980490784847947699: UserCountryModelBase_requestUserCountry(),
    1855922599480816194: UserCountryModelBase_showPaymentWindow(),
    3473864056438530076: UserCountryModelServer_checkUserPaymentCountry(),
    6837641584512438278: UserCountryModelServer_setCurrentPaymentCountry(),
    ...
    28549105613333921: VideoAdsMobileLootBoxCC(),
    7748209094633432026: VideoAdsMobileLootBoxModelServer_showed(),
