# Codec definitions autogenerated on Fri, 09 Jul 2021 04:19:07 GMT
# Decompiler: JPEXS Free Flash Decompiler v.11.3.0
# game-e6e31c174a2fff1b0a55e754b52892b1.swf
# entrance-527844d7d3516ed790fef6999e16a5e5.swf
...
class BonkWeaponModelBase_hit(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
...
class BonkWeaponModelServer_hit(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['time'] = packet.readInt()
        data['hitPoint'] = Vector3d().read(packet, optional)
...
class TeslaModelBase_throwGlobeLightning(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['shooter'] = packet.readLong()
        data['direction'] = Vector3d().read(packet, optional)
...
class TeslaModelServer_globeLightningHitTarget(Codec):
    def read(self, packet, optional):
        data = super().read(packet, optional)
        data['clientTime'] = packet.readInt()
        data['facility'] = packet.readLong()
...
CODECS = {
    ...
    5991599447425832758: BonkWeaponModelBase_hit(),
    ...
    5991182121266943934: BonkWeaponModelServer_hit(),
    ...
    6190283511573306383: TeslaModelBase_throwGlobeLightning(),
    2377867740286648493: TeslaModelServer_globeLightningHitTarget(),
